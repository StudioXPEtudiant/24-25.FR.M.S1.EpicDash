...
namespace StudioXP.Scripts.Components.Common
{
    public class Spawnable : MonoBehaviour
    {
        ...
        [MinValue(0)]
        [SerializeField] private float despawnDistance = 24;
...
#pragma warning restore 0414
        ...
        private float GetCameraDistance()
        {
            ...
            var cameraDistance = (cameraPos - position).magnitude;
            cameraDistance -= _camera.scaledPixelWidth / 2.0f;
            if (cameraDistance < 0)
                cameraDistance = 0;
            ...
            Debug.DrawLine(position, cameraPos, color);
#endif
