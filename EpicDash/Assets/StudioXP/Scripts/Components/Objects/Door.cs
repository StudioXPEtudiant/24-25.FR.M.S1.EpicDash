...
namespace StudioXP.Scripts.Components.Objects
{
    ...
    public class Door : MonoBehaviour
    {
        ...
        {
            SoundRegistry.Instance.Play(openSound);
            ...
            if(Camera.main != null)
            {
                ...
                cameraTransform.position = new Vector3(destinationPosition.x, destinationPosition.y, cameraTransform.position.z);
            }

            openingObject.transform.position = destinationPosition;
        }
