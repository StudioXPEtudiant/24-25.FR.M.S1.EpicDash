...
namespace StudioXP.Scripts.Components.Movements.Characters
{
    ...
    public class JumpFunction : MonoBehaviour
    {
        ...
        public void SetMaxNbJump(int maximum)
        {
            _tempsMaxNbJump = maximum;
        }

        public void ResetMaxNbJump()
        {
            _tempsMaxNbJump = maxNbJump;
        }

        public void SetJumpingVelocity(float jumpingVelocity)
        {
            _tempSpeed = jumpingVelocity;
        }

        public void ResetJumpingVelocity()
        {
            _tempSpeed = speed;
        }
